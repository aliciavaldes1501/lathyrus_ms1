...
load(file = "C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/alldata.RData")
temperature<-read.table("C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/temperature.csv",header=T,sep="\t",dec=".") 
precipitation<-read.table("C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/precipitation.csv",header=T,sep="\t",dec=",") 
...
```{r Calculate temp, prec, GDD for different periods, message=FALSE}
weather_46<-subset(weather,month==4|month==5|month==6)                            # April-June
weather_45<-subset(weather,month==4|month==5)                                     # April-May
weather_16<-subset(weather,month==1|month==2|month==3|month==4|month==5|month==6) # January-June
weather_13<-subset(weather,month==1|month==2|month==3)                            # January-March
weather_34<-subset(weather,month==3|month==4)                                     # March-April

#April-June
mean_weather_46<-plyr::join_all(list(
    aggregate(mean ~ year,data=weather_46, FUN=mean),          #Mean daily temperature
    aggregate(min ~ year, data=weather_46, FUN=mean),          #Min daily temperature
    aggregate(max ~ year, data=weather_46, FUN=mean),          #Max daily temperature
    aggregate(precipitation ~ year, data= weather_46, FUN=sum),#Precipitation
    aggregate(GDD3 ~ year,data= weather_46, FUN=sum),          #GDD3
    aggregate(GDD5 ~ year,data= weather_46, FUN=sum),          #GDD5
    aggregate(GDD7 ~ year,data= weather_46, FUN=sum),          #GDD7
    aggregate(GDD10 ~ year,data= weather_46, FUN=sum),         #GDD10
    aggregate(GDH3 ~ year,data= weather_46, FUN=sum),          #GDH3
    aggregate(GDH5 ~ year,data= weather_46, FUN=sum),          #GDH5
    aggregate(GDH7 ~ year,data= weather_46, FUN=sum),          #GDH7
    aggregate(GDH10 ~ year,data= weather_46, FUN=sum)),        #GDH10       
    by = NULL, type = "left", match = "all")
colnames(mean_weather_46)[2:13]<-paste(colnames(mean_weather_46)[2:13],"46",sep = "_")

#April-May
mean_weather_45<-plyr::join_all(list(
    aggregate(mean ~ year,data=weather_45, FUN=mean),          #Mean daily temperature
    aggregate(min ~ year, data=weather_45, FUN=mean),          #Min daily temperature
    aggregate(max ~ year, data=weather_45, FUN=mean),          #Max daily temperature
    aggregate(precipitation ~ year, data= weather_45, FUN=sum),#Precipitation
    aggregate(GDD3 ~ year,data= weather_45, FUN=sum),          #GDD3
    aggregate(GDD5 ~ year,data= weather_45, FUN=sum),          #GDD5
    aggregate(GDD7 ~ year,data= weather_45, FUN=sum),          #GDD7
    aggregate(GDD10 ~ year,data= weather_45, FUN=sum),         #GDD10
    aggregate(GDH3 ~ year,data= weather_45, FUN=sum),          #GDH3
    aggregate(GDH5 ~ year,data= weather_45, FUN=sum),          #GDH5
    aggregate(GDH7 ~ year,data= weather_45, FUN=sum),          #GDH7
    aggregate(GDH10 ~ year,data= weather_45, FUN=sum)),        #GDH10       
    by = NULL, type = "left", match = "all")
colnames(mean_weather_45)[2:13]<-paste(colnames(mean_weather_45)[2:13],"45",sep = "_")

#January-June
mean_weather_16<-plyr::join_all(list(
    aggregate(mean ~ year,data=weather_16, FUN=mean),          #Mean daily temperature
    aggregate(min ~ year, data=weather_16, FUN=mean),          #Min daily temperature
    aggregate(max ~ year, data=weather_16, FUN=mean),          #Max daily temperature
    aggregate(precipitation ~ year, data= weather_16, FUN=sum),#Precipitation
    aggregate(GDD3 ~ year,data= weather_16, FUN=sum),          #GDD3
    aggregate(GDD5 ~ year,data= weather_16, FUN=sum),          #GDD5
    aggregate(GDD7 ~ year,data= weather_16, FUN=sum),          #GDD7
    aggregate(GDD10 ~ year,data= weather_16, FUN=sum),         #GDD10
    aggregate(GDH3 ~ year,data= weather_16, FUN=sum),          #GDH3
    aggregate(GDH5 ~ year,data= weather_16, FUN=sum),          #GDH5
    aggregate(GDH7 ~ year,data= weather_16, FUN=sum),          #GDH7
    aggregate(GDH10 ~ year,data= weather_16, FUN=sum)),        #GDH10       
    by = NULL, type = "left", match = "all")
colnames(mean_weather_16)[2:13]<-paste(colnames(mean_weather_16)[2:13],"16",sep = "_")

#January-March
mean_weather_13<-plyr::join_all(list(
    aggregate(mean ~ year,data=weather_13, FUN=mean),          #Mean daily temperature
    aggregate(min ~ year, data=weather_13, FUN=mean),          #Min daily temperature
    aggregate(max ~ year, data=weather_13, FUN=mean),          #Max daily temperature
    aggregate(precipitation ~ year, data= weather_13, FUN=sum),#Precipitation
    aggregate(GDD3 ~ year,data= weather_13, FUN=sum),          #GDD3
    aggregate(GDD5 ~ year,data= weather_13, FUN=sum),          #GDD5
    aggregate(GDD7 ~ year,data= weather_13, FUN=sum),          #GDD7
    aggregate(GDD10 ~ year,data= weather_13, FUN=sum),         #GDD10
    aggregate(GDH3 ~ year,data= weather_13, FUN=sum),          #GDH3
    aggregate(GDH5 ~ year,data= weather_13, FUN=sum),          #GDH5
    aggregate(GDH7 ~ year,data= weather_13, FUN=sum),          #GDH7
    aggregate(GDH10 ~ year,data= weather_13, FUN=sum)),        #GDH10       
    by = NULL, type = "left", match = "all")
colnames(mean_weather_13)[2:13]<-paste(colnames(mean_weather_13)[2:13],"13",sep = "_")

#March-April
mean_weather_34<-plyr::join_all(list(
    aggregate(mean ~ year,data=weather_34, FUN=mean),          #Mean daily temperature
    aggregate(min ~ year, data=weather_34, FUN=mean),          #Min daily temperature
    aggregate(max ~ year, data=weather_34, FUN=mean),          #Max daily temperature
    aggregate(precipitation ~ year, data= weather_34, FUN=sum),#Precipitation
    aggregate(GDD3 ~ year,data= weather_34, FUN=sum),          #GDD3
    aggregate(GDD5 ~ year,data= weather_34, FUN=sum),          #GDD5
    aggregate(GDD7 ~ year,data= weather_34, FUN=sum),          #GDD7
    aggregate(GDD10 ~ year,data= weather_34, FUN=sum),         #GDD10
    aggregate(GDH3 ~ year,data= weather_34, FUN=sum),          #GDH3
    aggregate(GDH5 ~ year,data= weather_34, FUN=sum),          #GDH5
    aggregate(GDH7 ~ year,data= weather_34, FUN=sum),          #GDH7
    aggregate(GDH10 ~ year,data= weather_34, FUN=sum)),        #GDH10       
    by = NULL, type = "left", match = "all")
colnames(mean_weather_34)[2:13]<-paste(colnames(mean_weather_34)[2:13],"34",sep = "_")

mean_weather3<-plyr::join_all(
  list(mean_weather2,mean_weather_46,mean_weather_45,mean_weather_16,mean_weather_13,mean_weather_34),        
    by = NULL, type = "left", match = "all")
```
...
mean_weather4<-merge(merge(mean_weather3,mean_weather2_b),
...
models<-lapply(names(mean_weather4)[c(7:9,19:21,31:33,43:45,
...
kable(arrange(subset(models_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models1<-lapply(names(mean_weather4)[c(7:9,19:21,31:33,43:45,
        55:57,67:69,79:81,91:93,103:105,115:117,127:129,139:141,146:217)], 
...
models2<-lapply(names(mean_weather4)[c(7:9,19:21,31:33,43:45,
        55:57,67:69,79:81,91:93,103:105,115:117,127:129,139:141,146:217)], 
...
kable(arrange(subset(models2_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models3<-lapply(names(mean_weather4)[c(7:9,19:21,31:33,43:45,
        55:57,67:69,79:81,91:93,103:105,115:117,127:129,139:141,146:217)], 
...
kable(arrange(subset(models3_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models4<-lapply(names(mean_weather4)[c(7:9,19:21,31:33,43:45,
        55:57,67:69,79:81,91:93,103:105,115:117,127:129,139:141,146:217)], 
...
kable(arrange(subset(models4_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
grid.arrange(
  ggplot(mean_weather4,aes(x=mean_45,y=FFD_mean))+geom_point(size=1)+geom_smooth(method="lm")+
  xlab("Mean daily temperature April and May")+ylab("Mean FFD")+geom_text(x=9,y=70,label="R2=0.76"),
ggplot(mean_weather4,aes(x=precipitation_13,y=FFD_mean))+geom_point(size=1)+geom_smooth(method="lm")+
  xlab("Sum of precipitation January-March")+ylab("Mean FFD")+geom_text(x=200,y=70,label="R2=0.17"),
ggplot(mean_weather4,aes(x=min_4,y=FFD_var))+geom_point(size=1)+geom_smooth(method="lm")+
  xlab("Min daily temperature April")+ylab("Variance FFD")+geom_text(x=2.5,y=50,label="R2=0.47"),
ggplot(mean_weather4,aes(x=precipitation_13,y=FFD_var))+geom_point(size=1)+geom_smooth(method="lm")+
  xlab("Sum of precipitation January-March")+ylab("Variance FFD")+geom_text(x=150,y=50,label="R2=0.39"),
ggplot(mean_weather4,aes(x=mean_4,y=FFD_dur))+geom_point(size=1)+geom_smooth(method="lm")+
  xlab("Mean daily temperature April")+ylab("Range FFD")+geom_text(x=6,y=33,label="R2=0.33"),
ggplot(mean_weather4,aes(x=precipitation_4,y=FFD_dur))+geom_point(size=1)+geom_smooth(method="lm")+
  xlab("Sum of precipitation April")+ylab("Range FFD")+geom_text(x=60,y=30,label="R2=0.24"),
ggplot(mean_weather4,aes(x=max_3,y=FFD_skew))+geom_point(size=1)+geom_smooth(method="lm")+
...
summary(lm(FFD_mean~mean_45+precipitation_13,mean_weather4)) #Increase from 0.76 to 0.78
summary(lm(FFD_var~min_4+precipitation_13,mean_weather4))  #Increase from 0.47 to 0.54
summary(lm(FFD_dur~mean_4+precipitation_4,mean_weather4))  #Increase from 0.33 to 0.37
```
...
write.table(alldata_weather,file="C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/alldata_weather.csv",sep="\t",dec=",",col.names=T,row.names=F)
write.table(tomerge,file="C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/tomerge.csv",sep="\t",dec=",",col.names=T,row.names=F)
```
...
kable(arrange(subset(models5_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
with(mean_weather4,plot(GDD3_16~as.factor(year),ylab="GDD3 January-June",xlab="year"))

grid.arrange(ggplot(mean_weather4,aes(year,GDD3_1))+
...
mean_weather4_w<-plyr::join_all(list(
...
colnames(mean_weather4_w)[2:11]<-paste(colnames(mean_weather4_w)[2:11],"w", sep = "_")

mean_weather5<-merge(mean_weather4,mean_weather4_w) #Merge with previous data
```
...
models6<-lapply(names(mean_weather5)[c(223:232)], 
         function(x) {lm(substitute(FFD_mean ~ scale(i), list(i = as.name(x))),
                          data = mean_weather5)})
...
kable(arrange(subset(models6_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models7<-lapply(names(mean_weather5)[c(223:232)], 
         function(x) {lm(substitute(FFD_var ~ scale(i), list(i = as.name(x))),
                          data = mean_weather5)})
...
kable(arrange(subset(models7_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models8<-lapply(names(mean_weather5)[c(223:232)], 
         function(x) {lm(substitute(FFD_dur ~ scale(i), list(i = as.name(x))),
                          data = mean_weather5)})
...
kable(arrange(subset(models8_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models9<-lapply(names(mean_weather5)[c(223:232)], 
         function(x) {lm(substitute(FFD_skew ~ scale(i), list(i = as.name(x))),
                          data = mean_weather5)})
...
kable(arrange(subset(models9_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models10<-lapply(names(mean_weather5)[c(223:232)], 
         function(x) {lm(substitute(FFD_kurt ~ scale(i), list(i = as.name(x))),
                          data = mean_weather5)})
...
kable(arrange(subset(models10_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
grid.arrange(
  ggplot(mean_weather5,aes(x=precipitation_w,y=FFD_mean))+geom_point(size=1)+
    geom_smooth(method="lm")+xlab("Sum of precipitation in winter")+ylab("Mean FFD"),
  ggplot(mean_weather5,aes(x=mean_w,y=FFD_mean))+geom_point(size=1)+
    geom_smooth(method="lm")+xlab("Mean temperature in winter")+ylab("Mean FFD"),
  ggplot(mean_weather5,aes(x=precipitation_w,y=FFD_var))+geom_point(size=1)+
    geom_smooth(method="lm")+xlab("Sum of precipitation in winter")+ylab("Variance FFD"),
  ggplot(mean_weather5,aes(x=min_w,y=FFD_mean))+geom_point(size=1)+
...
mean_weather6<-merge(mean_weather5,coefs_models11)

#Fit univariate linear models of resp_cumGDH3v against each winter predictor
models12<-lapply(names(mean_weather6)[c(223:232)], 
...
kable(arrange(subset(models12_summary,sig=="*"|sig=="**"|sig=="***"),desc(Rsquare)))
```
...
models13<-lapply(names(mean_weather6)[c(223:232)], 
         function(x) {lm(substitute(FFD_mean ~ scale(mean_45)*scale(i), list(i = as.name(x))),
                          data = mean_weather6)})
...
save.image(file = "C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/code/image1.RData")
```
...
* The range of FFD increases with temperature in April and decreases with precipitation in April
