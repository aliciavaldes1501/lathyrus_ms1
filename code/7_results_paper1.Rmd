...
weather_GDD<-write_csv(weather,
                       file="C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/weather_GDD.csv")
```
...
write.table(mean_weather4,file="C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/mean_weather.csv",
            sep="\t",dec=".",col.names=T,row.names=F)
```
...
```{r FFD-MFD-LFD}
MFD_LFD<-read.delim("C:/Users/User/Dropbox/SU/Projects/lathyrus/lathyrus_ms1/data/clean/MFD_LFD.csv")
...
importance(modsel_FFD_prev) # Variable importance
...
importance(modsel_direct_selection_prev) # Variable importance
...
importance(modsel_FFD_prev_curr) # Variable importance
